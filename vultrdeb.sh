#!/bin/bash
#Autoscript Created ByRizwan Arif Firmansyah ( acill.sadank@gmail.com ) ( https://wa.me/6283145968517 )
clear
...
echo "Squid3      : 80, 8080, 3128"  | tee -a log-install.txt | lolcat
echo "OpenSSH     : 22"  | tee -a log-install.txt | lolcat
echo "Dropbear    : 143, 443"  | tee -a log-install.txt | lolcat
